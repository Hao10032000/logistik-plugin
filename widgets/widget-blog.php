...
class TFBlog_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Blog Posts', 'themesflat-addons' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'multiple' => true,
                'label_block' => true,
                'description' => esc_html__( 'Select categories to display posts from.', 'themesflat-addons' ),
            ]
        );
        ...
        $this->add_control(
            'exclude',
            [
                'label' => esc_html__( 'Exclude Posts', 'themesflat-addons' ),
                'type'  => \Elementor\Controls_Manager::TEXT,
                'description' => esc_html__( 'Enter post IDs to exclude, separated by commas (e.g., 1,2,3).', 'themesflat-addons' ),
                'default' => '',
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'sort_by_id',
            [
                'label' => esc_html__( 'Sort By Specific IDs', 'themesflat-addons' ),
                'type'  => \Elementor\Controls_Manager::TEXT,
                'description' => esc_html__( 'Enter post IDs to sort specifically, separated by commas (e.g., 1,2,3). This will override other sorting options.', 'themesflat-addons' ),
                'default' => '',
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'show_read_more',
            [
                'label' => esc_html__( 'Show Read More Button', 'themesflat-addons' ),
        ...
        $this->add_control(
            'read_more_text',
            [
                'label' => esc_html__( 'Read More Text', 'themesflat-addons' ),
                'type' => \Elementor\Controls_Manager::TEXT,
    ...
    protected function render($instance = []) {
        ...
        $this->add_render_attribute( 'tf_blog_wrap', ['class' => ['tf-blog-wrap', 'themesflat-blog-posts' ], 'data-tabid' => $this->get_id()] );
...
<div <?php echo $this->get_render_attribute_string('tf_blog_wrap'); ?>
    ...
    <div class="wrap-blog-posts blog-container row ">
                    ...
                    <article class="blog-post">
                        ...
                        <?php if ( has_post_thumbnail() ): ?>
                            <div class="post-thumbnail">
                                <a href="<?php echo get_the_permalink(); ?>">
                                    ...
                                    echo sprintf('<img src="%s" alt="%s">', \Elementor\Group_Control_Image_Size::get_attachment_image_src( $get_id_post_thumbnail, 'thumbnail', $settings ), get_the_title());
                                    ?>
                                </a>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="post-content">
                            ...
                            <?php if ( $settings['show_read_more'] == 'yes' ): ?>
                                <a href="<?php echo get_the_permalink(); ?>" class="tf-btn-read-more">
...
<?php
            ...
            esc_html_e('No blog posts found', 'themesflat-addons');
        endif;
    }

    /**
     * Get a list of blog categories for the Elementor control.
     *
     * @return array
     */
